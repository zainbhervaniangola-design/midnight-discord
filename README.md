...
1. download the theme file, [`midnight.theme.css`](https://github.com/zainbhervaniangola-design/midnight-discord/blob/main/README.md). (there should be a download button at the top right of the page)
